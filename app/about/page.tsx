...
export default function AboutPage() {
  ...
  const careerStats = [
    {
      icon: FaFlag,
      labelKey: "about.internationalMatches",
      valueKey: "about.internationalMatchesValue",
      color: "from-red-500 to-red-600",
    },
    {
      icon: FaTrophy,
      labelKey: "about.clubTitles",
      valueKey: "about.clubTitlesValue",
      color: "from-blue-500 to-cyan-600",
    },
    {
      icon: FaMedal,
      labelKey: "about.careerYears",
      valueKey: "about.careerYearsValue",
      color: "from-purple-500 to-pink-600",
    },
    {
      icon: FaStar,
      labelKey: "about.specialHonors",
      valueKey: "about.specialHonorsValue",
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {careerStats.map((stat, idx) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${stat.color} rounded-2xl blur opacity-25 group-hover:opacity-50 transition-all`}
                ></div>
                <div className="relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all text-center border border-slate-200">
                  <div
                    className={`inline-flex p-4 bg-gradient-to-br ${stat.color} rounded-xl mb-4`}
                  >
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-slate-50 to-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* Vertical Line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-red-200 via-blue-200 to-purple-200 hidden md:block"></div>
              ...
              {timelineItems.map((item, idx) => (
                ...
                >
                  ...
                  <div className="absolute left-1/2 transform -translate-x-1/2 hidden md:flex">
                    <div className="w-4 h-4 bg-white border-4 border-red-500 rounded-full shadow-lg"></div>
                  </div>

                  {/* Card */}
                  <div
                    className={`w-full md:w-[38%] ${item.align === "left" ? "md:ml-[100px]" : "md:mr-[100px]"}`}
                  >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="space-y-6 text-lg text-slate-700 leading-relaxed">
                ...
                <p>
                  <strong>{t("about.internationalCareerText2")}</strong>
                </p>
                <p>
                  <strong>{t("about.internationalCareerText3")}</strong>
                </p>
