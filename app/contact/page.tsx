...
export default function ContactPage() {
  ...
  const email =
    settings?.company_email || "captainaminulhoquedhaka16@gmail.com";
    ...
    <main className="bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      <section className="py-20 px-4 max-w-7xl mx-auto">
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-red-500 rounded-2xl blur opacity-20"></div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
            {contactInfo.map((info, idx) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${info.color} rounded-2xl blur opacity-25 group-hover:opacity-50 transition-all`}
                ></div>
                <div className="relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all text-center border border-slate-200 h-full flex flex-col justify-center">
                  <div
                    className={`inline-flex p-4 bg-gradient-to-br ${info.color} rounded-xl mb-4 shadow-lg mx-auto`}
                  >
                  ...
                  <p
                    className={`text-2xl font-black mb-1 bg-gradient-to-r ${info.color} bg-clip-text text-transparent`}
                  >
                    {info.value}
                  </p>
                  {info.subtextKey && (
              ...
              <div className="relative">
                ...
                <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-slate-200">
                  ...
                  <div className="text-center py-4">
                    <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 rounded-full">
