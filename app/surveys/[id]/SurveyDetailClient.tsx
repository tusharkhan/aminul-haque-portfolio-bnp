    ...
    try {
      ...
      answers.forEach((answer, index) => {
        formDataToSend.append(
          `answers[${index}][survey_id]`,
          answer.survey_id.toString(),
        );
        formDataToSend.append(
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.message ||
            `Failed to submit survey: ${response.statusText}`,
        );
      }
      ...
      setSubmitError(
        error instanceof Error ? error.message : t("surveysPage.submitError"),
      );
    } finally {
      setSubmitting(false);
    }
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            <h2 className="text-3xl font-black text-slate-900 mb-4">
              {t("surveysPage.surveyNotFound")}
            </h2>
            <p className="text-slate-600 mb-6">
              {t("surveysPage.surveyNotFoundDesc")}
            </p>
            <Link
              href="/surveys"
              ...
              <div className="space-y-8">
                {survey.questions.map((question, idx) => (
                  ...
                  >
                    ...
                    question.formatted_options.length > 0 ? (
                        ...
                        {question.formatted_options.map((option, optIdx) => (
                          ...
                          >
                            <input
                              ...
                              value={option}
                              checked={
                                formData.answers[question.id.toString()] ===
                                option
                              }
                              onChange={(e) =>
